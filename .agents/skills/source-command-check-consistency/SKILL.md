---
name: "source-command-check-consistency"
description: "Strukturelle Konsistenzprüfung der drei Forks (main, gi-telaviv, wifi)"
---

# source-command-check-consistency

Use this skill when the user asks to run the migrated source command `check-consistency`.
